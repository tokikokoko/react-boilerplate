...
const cardLeftBackground = 'https://tailwindcss.com/img/card-left.jpg';
const iconImage = 'https://pbs.twimg.com/profile_images/885868801232961537/b1F6H4KC_400x400.jpg';

export const App: FC = () => {
  return (
  <div>
    <div className="max-w-md w-full lg:flex">
      <div className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style={{backgroundImage: `url(${cardLeftBackground})`}} title="Woman holding a mug">
      </div>
      <div className="border-r border-b border-l border-grey-light lg:border-l-0 lg:border-t lg:border-grey-light bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
        ...
        <div className="flex items-center">
          <img className="w-10 h-10 rounded-full mr-4" src={iconImage} alt="Avatar of Jonathan Reinink"></img>
